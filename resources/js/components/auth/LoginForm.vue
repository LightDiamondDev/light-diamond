...
<template>
    ...
    <form action="" class="login flex flex-col items-center">
        ...
        <div class="header flex justify-between items-center">
            <button class="flex justify-center items-center m-4" @click="AuthFormType.REGISTER" type="button">
        ...
        <fieldset class="flex flex-col items-center">
            ...
            <div class="auth-options flex justify-between mt-2">
                ...
                <button class="help-button flex items-center" type="button">
                    <span class="text-[0.8rem]" @click="AuthFormType.FORGOT_PASSWORD">Забыли пароль?</span>
                </button>
            </div>
        </fieldset>
        ...
        <button class="help-button mb-2 mt-2" type="button">
            <span class="p-2 text-[0.9rem]" @click="AuthFormType.REGISTER">Ещё нет учётной записи?</span>
        </button>
