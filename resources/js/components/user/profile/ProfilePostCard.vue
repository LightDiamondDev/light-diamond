...
<template>
    <div class="post-version-card flex md:flex-row flex-col" style="border-bottom: 2px solid rgba(255, 255, 255, .5)">
        <div class="flex w-full gap-2 py-2">
            ...
            <div class="description-wrap flex flex-col w-full">
                ...
                <PostActionBar class="ld-secondary-background-container sm:flex hidden gap-4 mt-2" :post="post"/>
            </div>
        </div>
