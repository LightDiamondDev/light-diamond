...
function loadMaterials() {
    ...
    axios.get(`/api/users/${props.userId}/materials`, {params: loadRequestData}).then((response) => {
...
<template>
    <div>
        <div v-if="isLoading && materials.length < 1" class="flex flex-col">
...
.paginator-refresh .material-submission-card {
    opacity: 0;
}
</style>
