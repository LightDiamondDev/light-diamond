...
<template>
    ...
    <div class="post-editor-header flex justify-center w-full">
        <slot name="header"/>
    </div>

    <div class="first-section ld-secondary-background flex justify-center w-full">
        <div class="page-container xl">
            <section class="flex flex-col justify-center items-center">
                ...
                <div class="content page-container w-full px-4">
